...
public enum ArithmeticOperatorDeletionLast implements MethodMutatorFactory {

    DELETE_ARITHMETIC_LAST_MUTATOR;

    @Override
    public MethodVisitor create(final MutationContext context,
                                final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new ArithmeticDeleteLastMethodVisitor(this, methodInfo, context, methodVisitor);
    }
...
class ArithmeticDeleteLastMethodVisitor extends AbstractInsnMutator {

    private static final String                     DESCRIPTION = "delete arithmetic operator (second operand)";
    ...
    ArithmeticDeleteLastMethodVisitor(final MethodMutatorFactory factory,  final MethodInfo methodInfo,
