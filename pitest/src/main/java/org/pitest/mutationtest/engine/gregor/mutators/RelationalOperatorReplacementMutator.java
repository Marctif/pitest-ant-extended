...
public enum RelationalOperatorReplacementMutator implements MethodMutatorFactory {
    ...
    REPLACE_RELATIONAL_MUTATOR;

    @Override
    public MethodVisitor create(final MutationContext context,
                                final MethodInfo methodInfo, final MethodVisitor methodVisitor) {
        return new RelationalMethodVisitor(this, context, methodVisitor);
    }
...
class RelationalMethodVisitor extends AbstractJumpMutator {

    private static final String                     DESCRIPTION = "replace relational operator";
    ...
    RelationalMethodVisitor(final MethodMutatorFactory factory,
